...
Slope: $(-x^{*})$ & -97.964 & 1.960 & -49.987 & -96.360 & 6.459 & -14.919 \\ \hline
Adj. $R^2$ & \multicolumn{3}{|c|}{0.985791442785941\%} & \multicolumn{3}{|c||}{0.860238755016576\%} \\ \hline
Range: $g[i]$ & \multicolumn{3}{|c|}{$(9.775\%)$} & \multicolumn{3}{|c||}{$(10.903\%)$} \\ \hline
Average: $g[i]$ & \multicolumn{3}{|c|}{G \; = \; $9.775\%\%$} & \multicolumn{3}{|c||}{G \; = \; $10.903\%\%$} \\ \hline
Plateau (+/-): $\lambda^{*}$ & \multicolumn{3}{|c|}{$ (1.000, 287.000)$} & \multicolumn{3}{|c||}{$ (1.000, 159.000)$} \\ \hline
